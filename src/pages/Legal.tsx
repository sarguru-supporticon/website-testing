          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  To provide AI-assisted responses and recommendations, we process support-related content that you choose to connect to our app. This may include tickets, conversations, knowledge base resources, and similar support data, along with metadata such as timestamps and tags.
                </p>
              </div>
