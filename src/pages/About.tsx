              ...
              <div className="flex items-center gap-4 py-4 border-t border-green-50">
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border-2 border-white bg-green-100 flex items-center justify-center"
                    >
                ...
                <p className="text-sm font-medium text-slate-500">
                  Trusted by modern support leaders
                </p>
              </div>
            </div>
          ...
          <Card className="p-8 md:p-12 rounded-[2.5rem] border-green-50 shadow-xl bg-white/70 backdrop-blur-md">
            <div className="prose prose-lg max-w-none text-slate-500 leading-relaxed">
              <p className="mb-6 first-letter:text-5xl first-letter:font-bold first-letter:text-green-600 first-letter:mr-3 first-letter:float-left">
                Every meaningful company starts with a personal story. Ours
