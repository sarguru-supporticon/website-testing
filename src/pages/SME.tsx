  ...
  return (
    <main>  
      ...
      <section className="container mx-auto grid items-center gap-8 px-4 pb-20 md:grid-cols-2">
        <div>
          <h2 className="font-display text-3xl font-bold">Configure Resources for better answers</h2>
          <p className="mt-3 text-muted-foreground">
            SMEs can curate KB/Internal Resources and KT docs to improve draft quality. Keep content up‑to‑date,
