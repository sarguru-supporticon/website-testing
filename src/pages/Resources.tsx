    ...
    <main className="min-h-screen bg-transparent pb-20 overflow-hidden">
      ...
      <section className="container mx-auto px-4 py-8 md:py-16 relative">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <h1 className="font-display text-5xl md:text-7xl font-extrabold text-slate-900 mb-6 tracking-tight">
            Resource Hub
          </h1>
        ...
        {activeTab === "sources" ? (
          <div className="text-center py-20 px-4 bg-white/60 backdrop-blur-md rounded-3xl border border-green-100 shadow-lg">
            ...
            <Link
              to="/sources"
              className="inline-flex items-center gap-2 bg-green-600 text-white px-8 py-3.5 rounded-full font-semibold hover:bg-green-700 transition-all hover:scale-105 hover:shadow-lg shadow-green-300/30"
            >
