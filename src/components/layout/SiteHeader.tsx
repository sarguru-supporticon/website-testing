        ...
        <div className="container mx-auto flex h-[68px] items-center justify-between px-4 md:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="hidden sm:inline-flex rounded-full px-5 font-bold shadow-md shadow-emerald-200/60 hover:shadow-emerald-300/80 hover:scale-[1.03] transition-all duration-300"
              onClick={() =>
                window.open(
