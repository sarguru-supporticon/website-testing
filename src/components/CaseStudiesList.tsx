...
import { ArrowRight, Activity, TrendingUp, BookOpen, Clock, Users, Lightbulb, Shield, Briefcase, Workflow, CheckCircle, Database, Eye, MessageSquare, Zap, BarChart, X } from "lucide-react";
...
export const caseStudies = [
  {
    ...
    pain: "Agent burnout",
    feature: "Auto-Pilot",
    summary: "AI resolves repetitive tickets automatically, reducing late-night workload.",
    icon: MessageSquare,
    paragraphs: [
    ...
    featureExplanation: "HelpDude feature: Auto-Pilot autonomous resolution for high-confidence repeat tickets. No agent required."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Built-in ROI dashboard. Deflection count, resolution time, confidence scores, override rate — automatically tracked from day one."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Knowledge Capture Loop. Every agent correction trains the team's AI automatically. No manual KB updates required."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Co-Pilot with inline citations. Every suggested reply shows exactly where the answer came from."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Auto-Pilot 24/7 autonomous resolution. No agent required for high-confidence tickets regardless of time zone or shift pattern."
  },
  {
    ...
    featureExplanation: "HelpDude features: Co-Pilot suggested replies + Knowledge Capture Loop. Senior engineer expertise captured automatically, accessible to every agent on every shift."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Co-Pilot with Multilayer RAG — KB articles, past tickets, and customer history searched simultaneously."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Knowledge Capture Loop identifying recurring patterns from resolved tickets. Support intelligence that reaches product decisions."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Co-Pilot with full ticket and customer history context. Every agent who opens the ticket starts where the last one finished."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Co-Pilot 11-second suggested reply. Frees agent cognitive capacity for quality, judgment, and tone — not search."
  },
  {
    ...
    featureExplanation: "HelpDude feature: ROI Dashboard. Deflection count, resolution time, and SLA data that makes support's contribution to retention visible and quantifiable."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Knowledge Capture Loop. Agent resolutions become team knowledge automatically — no KB article required."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Auto-Pilot deflection + ROI dashboard showing ticket volume handled without agent touch. The metric and the story behind it."
  },
  {
    ...
    featureExplanation: "HelpDude feature: Co-Pilot with inline citations on every suggestion. Agents see exactly where the answer came from before they send."
  },
  {
    ...
    featureExplanation: "HelpDude features: Full stack — Auto-Pilot deflection, Co-Pilot with citations, Knowledge Capture Loop, ROI Dashboard. Support intelligence that earns a seat at the strategic table."
  }
];
    ...
    <>
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 animate-in fade-in slide-in-from-bottom-5 duration-700 relative z-10">
        {caseStudies.map((study, i) => {
          const slug = study.title.toLowerCase().replace(/[^\w\s]/gi, '').replace(/\s+/g, '-');
          return (
            <Card 
              key={i} 
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="mb-5 flex-grow">
                  <div className="text-xs font-bold text-rose-500 mb-2 uppercase tracking-wide">
                    Problem: <span className="font-semibold text-slate-600 normal-case tracking-normal ml-1">{study.pain}</span>
                  </div>
                ...
                <div className="mt-auto pt-4 flex flex-col gap-4 border-t border-slate-100">
                  <div className="inline-flex items-center gap-2 bg-[#E8F5D8]/80 px-3 py-1.5 rounded-lg border border-[#C8E6A0]/50 self-start">
                    <span className="text-[10px] font-bold text-green-800 uppercase tracking-widest">Built With:</span>
                    <span className="text-xs font-bold text-green-900">{study.feature}</span>
                  </div>
